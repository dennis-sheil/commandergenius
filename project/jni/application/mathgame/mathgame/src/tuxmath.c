...
// TUXLOCALE defined same as WIN32 is on Android
// I commented out the non-WIN32 and non-Android option for now
// It should probably be put back if this goes in Tuxmath baseline
//
//#ifdef WIN32
