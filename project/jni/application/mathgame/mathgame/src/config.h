...
The correctness of this file on Android is unknown.  It has to
be looked at more carefully, or perhaps dealt with differently
on the Android port.  The defined variables are not
carefully defined for Android, but more of a wild guess which
seem to work on a surface level.  They must be verified, or
at least program access to config.h must be turned off
...
/* Define to 1 if you have the `t4kcommon' library (-lt4kcommon). */
/* #undef HAVE_LIBT4KCOMMON */
...
/* Define to 1 if you have the `Mix_Init' function. */
/* #undef HAVE_MIX_INIT */
...
/* Define to 1 if you have the `libRSVG` library */
/* #undef HAVE_RSVG */
